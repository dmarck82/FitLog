...
$rotas = [
    'GET' => [
        ...
        '/esqueci-senha' => 'exibir_esqueci_senha',
        '/redefinir-senha' => 'exibir_redefinir_senha',
        '/pesos' => 'listar_pesos',
    ...
    'POST' => [
        ...
        '/esqueci-senha' => 'processar_esqueci_senha',
        '/redefinir-senha' => 'processar_redefinir_senha',
        ...
        '/perfil/senha' => 'alterar_senha_perfil',
